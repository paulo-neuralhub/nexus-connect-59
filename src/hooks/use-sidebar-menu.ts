  ...
  // Gestión Principal - incluye Expedientes, Clientes, CRM
  {
    ...
    modules: [
      ...
      },
      {
        ...
        moduleExpanded: true,
        moduleMenuItems: [
          { label: "Pipeline", path: "/app/crm", icon: "KanbanSquare", badge: "" },
          { label: "Leads", path: "/app/crm/leads", icon: "UserPlus", badge: "leads" },
          { label: "Negocios", path: "/app/crm/deals", icon: "Briefcase", badge: "deals" },
          { label: "Clientes", path: "/app/crm/accounts", icon: "Building2", badge: "" },
          { label: "Contactos", path: "/app/crm/contacts", icon: "Users", badge: "" },
          { label: "Actividades", path: "/app/crm/interactions", icon: "Activity", badge: "" },
          { label: "Tareas", path: "/app/crm/tasks", icon: "CheckSquare", badge: "tasks" },
          { label: "Configuración", path: "/app/crm/pipelines", icon: "Settings", badge: "" },
        ],
        moduleRequires: [],
        modulePopular: true,
        moduleComingSoon: false,
