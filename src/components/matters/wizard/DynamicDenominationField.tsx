...
const TRADEMARK_FIELD_CONFIG: Record<TrademarkType, {
  ...
  pattern: {
    ...
    placeholder: 'Ej: Patrón repetitivo de líneas diagonales azules y doradas aplicado sobre toda la superficie',
    helperText: 'Describe el patrón visual y cómo se repite. Podrás adjuntar imágenes de referencia.',
    isTextArea: true,
    rows: 4,
    hasImage: true,
  },
  multimedia: {
    icon: Play,
    label: 'Descripción del elemento multimedia',
    placeholder: 'Ej: Secuencia audiovisual breve con animación del logotipo y sonido de entrada de 2 segundos',
    helperText: 'Describe la combinación de imagen, animación y/o sonido que forma la marca.',
    isTextArea: true,
    rows: 4,
    hasVideo: true,
    hasAudio: true,
  ...
  motion: {
    ...
    placeholder: 'Ej: Logotipo que se desplaza de izquierda a derecha y termina con un giro suave',
