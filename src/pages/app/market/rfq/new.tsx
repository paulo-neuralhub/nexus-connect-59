          ...
          <React.Fragment key={n}>
            ...
            {i < arr.length - 1 && (
              <div
                ...
                style={{ background: step > n ? 'linear-gradient(135deg, #00b4d8, #00d4aa)' : '#e8ecf3' }}
              />
            )}
          </React.Fragment>
        ))}
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <Icon
                              className="w-4 h-4"
                              style={{ color: selected ? '#00b4d8' : '#94a3b8' }}
                            />
                          </div>
                          <span
                            style={{
          ...
          <SilkCard title="Detalles de la solicitud" subtitle="Describe tu necesidad con el mayor detalle posible">
                    ...
                    {JURISDICTIONS.map(j => {
                      ...
                      return (
                        <button
                          ...
                          style={
                            selected
                              ? { background: 'rgba(0,180,216,0.08)', color: '#00b4d8', border: '1px solid rgba(0,180,216,0.2)' }
            ...
            {isTrademark && (
              <div
                ...
                style={{ background: '#f8fafc', border: '1px solid rgba(0,180,216,0.1)' }}
              >
                <h4 style={{ fontSize: '11px', fontWeight: 700, color: '#00b4d8', textTransform: 'uppercase', marginBottom: '10px' }}>
                    ...
                    render={({ field }) => (
                      <label className="flex items-center gap-2 cursor-pointer">
                        <div
                          ...
                          style={{
                            background: field.value ? '#00b4d8' : '#fff',
                            border: `1px solid ${field.value ? '#00b4d8' : 'rgba(0,0,0,0.15)'}`,
                          }}
