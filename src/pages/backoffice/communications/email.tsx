...
export default function BackofficeEmailCommunicationsPage() {
  const query = useQuery({
    queryKey: ["bo-communications", "email"],
    queryFn: async () => {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Email Soporte</h1>
      ...
      <Card>
        ...
        <CardContent>
          {query.isLoading ? (
            ...
            <p className="text-sm text-muted-foreground">Sin emails.</p>
          ) : (
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0">
                        <p className="font-medium truncate">{c.subject || "(sin asunto)"}</p>
